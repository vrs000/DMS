                                      ...
                                      QVector<QString> preferredProjects, QVector<QString> rejectedProjects)
{
    ...
    qDebug() << AlgorithmComplexity << CurrentIterationCount << IO::ProjectsNames.size() << IO::IndicatorsNames.size();
